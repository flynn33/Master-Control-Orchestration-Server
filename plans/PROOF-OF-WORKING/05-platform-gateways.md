...
Command: `curl -X POST --data-binary @mcos_post_apple_add.json .../apple-hosts`
...
Command: `curl -X POST --data-binary @mcos_post_apple_remove.json .../apple-hosts/remove`
...
Command: `curl -X POST --data-binary @mcos_post_apple_bad.json .../apple-hosts` (platforms=[])
