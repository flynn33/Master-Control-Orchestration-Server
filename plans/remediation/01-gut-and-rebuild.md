...
**Code changes.**
- New file `docs/wiki/Architecture-Decisions/ADR-001-lan-client-control-plane.md` stating the decision, the Forsetti governance alignment, and the explicit rejection of embedded provider runtimes.
