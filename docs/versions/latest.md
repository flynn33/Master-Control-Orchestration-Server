...
## Highlights
- legacy substrate retired in v0.9.0; native HTTP.sys is the only shipping gateway (`0.0.0.0:cfg.mcpGateway.listenPort` at `cfg.mcpGateway.mcpPath`, defaults `8080:/mcp`).
