...
- `docs/archive/proof-of-working/03-command-stream.md`, `08-starter-workflows.md`, `09-sub-agents.md`, `11-lan-client-end-to-end.md`, `17-soak-stability.md`, `plans/API-PROBE-RESULTS.md`, `plans/FEATURE-AUDIT.md`, `docs/archive/proof-of-working/PROOF-OF-WORKING.md`, `docs/archive/remediation/01-gut-and-rebuild.md`, `docs/archive/remediation/02-removal-inventory.md`: pre-removal planning evidence.
