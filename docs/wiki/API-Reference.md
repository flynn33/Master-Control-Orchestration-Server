...
The full 13-step verification scenario lives in [`docs/archive/proof-of-working/11-lan-client-end-to-end.md`](https://github.com/flynn33/Master-Control-Orchestration-Server/blob/main/docs/archive/proof-of-working/11-lan-client-end-to-end.md).
