...
|---|---|---|
| `A3.12.0` | 2026-07-31 | Model Parity: provider-neutral Client Integration Catalog for Claude Code, Codex, OpenAI Responses, ChatGPT Apps/connector edge, xAI Responses, Grok Build, Grok Build ACP, and generic MCP. GitHub pre-release with MSI (includes sqlite3.dll installer payload fix). |
