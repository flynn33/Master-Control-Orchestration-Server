...
![version](https://img.shields.io/badge/version-v0.6.5-00f6ff?style=flat-square)
...
msiexec /i "dist\packages\release\MasterControlOrchestrationServer-v0.6.5-win-x64\MasterControlOrchestrationServer-v0.6.5-win-x64.msi"
