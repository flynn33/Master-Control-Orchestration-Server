...
| [docs/wiki/Operations/Packaging-and-Gateway-Binary.md](../../docs/wiki/Operations/Packaging-and-Gateway-Binary.md) | New. What MSI installs, why the in-process HTTP.sys adapter is operator-installed (ADR-002 §11), supervised-mock fallback, post-install smoke (`bootstrapper preflight`, console mode), uninstall behavior. |
