...
| [docs/wiki/Operations/Packaging-and-Gateway-Binary.md](../../docs/wiki/Operations/Packaging-and-Gateway-Binary.md) | New. What MSI installs, why native HTTP.sys gateway is operator-installed (ADR-002 §11), supervised-mock fallback, post-install smoke (`bootstrapper preflight`, console mode), uninstall behavior. |
...
| native HTTP.sys gateway-backed end-to-end gateway exercise | Future hardening track | Requires a real gateway binary. Documented in the Packaging doc as an operator concern; the supervised-mock fallback honors ADR-002 §9 in the absence of a binary. |
