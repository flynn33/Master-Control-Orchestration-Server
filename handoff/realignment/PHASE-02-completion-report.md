...
Phase file: [handoff/realignment/PHASE-02-mcp-gateway-spike-the in-process HTTP.sys adapter.md](PHASE-02-mcp-gateway-spike-the in-process HTTP.sys adapter.md)
...
| [docs/implementation/FORBIDDEN-CONTRACT-GREP-LIST.md](../../docs/implementation/FORBIDDEN-CONTRACT-GREP-LIST.md) | Section 2.1 (the in-process HTTP.sys adapter coupling outside the adapter) updated to allow the new adapter file paths and reject any new coupling outside them. |
