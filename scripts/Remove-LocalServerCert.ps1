...
Write-Host "==> SUCCESS"
Write-Host ""
Write-Host "    To re-enable TLS, edit mcos.config.json and set:"
Write-Host '      cfg.mcpGateway.tlsEnabled = false'
Write-Host "    Then restart the service (or pass -RestartService to a later"
Write-Host "    Configure-LocalServerCert.ps1 run)."
